<resource schema="help_cosmos2015">
  ...
  <meta name="_longdoc" format="rst"> <![CDATA[
    ...
    The Laigle+ 2016 catalogue was limited to only good objects using this flag
    limit `(FLAG_COSMOS==1)&(FLAG_PETER==0)`.

    A column with an HELP identifier (`help_id`) has been added, please use
    this identifier when cross-matching.
    ...
    __ /help_cosmos2015/q/cone/static
